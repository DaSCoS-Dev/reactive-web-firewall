...
Vedere [`docs/it/OPENWRT-BACKEND-AUDIT.md`](docs/it/OPENWRT-BACKEND-AUDIT.md).
...
docs/en/             architettura, audit e release notes in inglese
docs/it/             architettura, audit e release notes in italiano
install.sh
uninstall.sh
```
...
[`docs/it/PRODUCTION-REFERENCE.md`](docs/it/PRODUCTION-REFERENCE.md) contiene la baseline osservata sul motore Inside
...
- [Architettura dei motori di rilevazione](docs/it/ENGINE-ARCHITECTURE.md)
- [Audit backend OpenWrt](docs/it/OPENWRT-BACKEND-AUDIT.md)
- [Audit delle regole Perl legacy](docs/it/PERL-RULE-AUDIT.md)
- [Riferimento di produzione](docs/it/PRODUCTION-REFERENCE.md)
- [Note di rilascio V7](docs/it/RELEASE-NOTES-V7.md)
